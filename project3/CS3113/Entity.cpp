...
void Entity::update(float deltaTime, Entity *collidableEntitiesA, Entity* collidableEntitiesB, int collisionCheckCountA, int collisionCheckCountB)
{
    ...
    checkCollisionY(collidableEntitiesA, collisionCheckCountA);
    checkCollisionY(collidableEntitiesB, collisionCheckCountB);

    mPosition.x += mVelocity.x * deltaTime;
    checkCollisionX(collidableEntitiesA, collisionCheckCountA);
    checkCollisionX(collidableEntitiesB, collisionCheckCountB);
